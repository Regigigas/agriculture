...
import { AlertTriangle, Bell, Bluetooth, Boxes, Bug, Building2, ClipboardList, CloudSun, DatabaseBackup, Download, FileCheck2, Gauge, Layers3, LogOut, Menu, MessageCircle, MessageSquareWarning, PackageSearch, RadioTower, ShieldAlert, ShoppingCart, Sprout, UserRound } from '@/icons/iconpark'
...
const menuOptions = computed<MenuOption[]>(() => [
  { type: 'group', label: '工作台', key: 'workbench', children: [
    ...
    { label: '农情决策中心', key: '/agronomy-decision', icon: icon(CloudSun) },
