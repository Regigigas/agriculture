...
.filter-bar { display: grid; grid-template-columns: minmax(190px, 1fr) 180px 150px auto; gap: 9px; margin-bottom: 12px; }.filter-bar .n-button { white-space: nowrap; }
