...
import { AlertTriangle, Boxes, Search, ShoppingCart } from '@lucide/vue'
...
<template>
  <page-header title="农资库存" description="掌握种子、肥料、农药及生产耗材的库存水平"><div class="summary-text warning"><AlertTriangle :size="17" />{{ lowCount }} 项低库存</div><n-button secondary @click="router.push('/purchases')"><template #icon><ShoppingCart /></template>采购补货</n-button></page-header>
